...
public class DecorateDoneFragment extends Fragment  {
    private View view;
    public static DecorateDoneFragment instance = null;
    private DecorateAllFragmentPresenter presenter;
    private RecyclerView recycleView;
    private SwipeRefreshLayout swiper;

    public static DecorateDoneFragment getInstance() {
        if (instance == null) {
            instance = new DecorateDoneFragment();
        }
        return instance;
    }
