...
public class PayOrderFragmentPresenter extends BasePresenter implements AllOrderAdapter.ItemClickListener,OnDataListener,SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = PayOrderFragmentPresenter.class.getSimpleName();
    ...
    public PayOrderFragmentPresenter(Context context){
        super(context);
    ...
    public void init(RecyclerView recyclerView, SwipeRefreshLayout swiper) {
        ...
        atm.request(GETALLORDER,PayOrderFragmentPresenter.this);
    }
    ...
    public Object doInBackground(int requestCode, String parameter) throws HttpException {
        switch (requestCode) {
            case GETALLORDER:
                return userAction.getMyOrder(pageIndex+"","281","278");
        }
        return null;
    }
