...
public class AllOrderFragmentPresenter extends BasePresenter implements AllOrderAdapter.ItemClickListener,OnDataListener,SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = AllOrderFragmentPresenter.class.getSimpleName();
    ...
    public AllOrderFragmentPresenter(Context context){
        super(context);
    ...
    public Object doInBackground(int requestCode, String parameter) throws HttpException {
        switch (requestCode) {
            case GETALLORDER:
                return userAction.getMyOrder(pageIndex+"",null,"278");
            case REMOVEORDER:
