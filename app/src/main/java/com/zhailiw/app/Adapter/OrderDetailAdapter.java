...
public class OrderDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    private List<OrderDetailResponse.DataBean.OrderListBean> listItems;
    ...
    public void setListItems(List<OrderDetailResponse.DataBean.OrderListBean> l)
    {
        this.listItems=l;
    }
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        else if(mFooterView != null &&viewType == TYPE_FOOTER)
        {
            ...
            View v = layoutInflater.inflate(R.layout.listitem_order_detail, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final OrderDetailResponse.DataBean.OrderListBean listItem = listItems.get(pos);
